...
public class Lexus extends LinearOpMode
{
    ...
    private void counterclockwise90()
    {
        // Reset encoder counts to 0
        frontleft.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
        frontright.setMode(DcMotorEx.RunMode.STOP_AND_RESET_ENCODER);
        ...
        // Set the distance the motors travel
        frontleft.setTargetPosition((int)(1.8 * 537.7));
        backleft.setTargetPosition((int)(1.8 * 537.7));
        frontright.setTargetPosition((int)(-1.8 * 537.7));
        backright.setTargetPosition((int)(-1.8 * 537.7));
